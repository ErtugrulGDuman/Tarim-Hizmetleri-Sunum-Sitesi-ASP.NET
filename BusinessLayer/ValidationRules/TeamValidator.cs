...
namespace BusinessLayer.ValidationRules
{
    public class TeamValidator : AbstractValidator<Team>
    {
        public TeamValidator()
        {
            ...
            RuleFor(x => x.PersonName).MinimumLength(5).WithMessage("En az 5 karakter girebilirsiniz");
            RuleFor(x => x.Title).MaximumLength(50).WithMessage("En fazla 50 karakter girebilirsiniz");
            RuleFor(x => x.Title).MinimumLength(3).WithMessage("En az 3 karakter girebilirsiniz");
        }
    }
}
