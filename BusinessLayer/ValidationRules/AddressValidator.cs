...
namespace BusinessLayer.ValidationRules
{
    public class AddressValidator : AbstractValidator<Address>
    {
        public AddressValidator()
        {
            ...
            RuleFor(x => x.Description1).MaximumLength(25).WithMessage("Lütfen açılamayı kısaltın");
            RuleFor(x => x.Description2).MaximumLength(25).WithMessage("Lütfen açılamayı kısaltın");
            RuleFor(x => x.Description3).MaximumLength(25).WithMessage("Lütfen açılamayı kısaltın");
            RuleFor(x => x.Description4).MaximumLength(25).WithMessage("Lütfen açılamayı kısaltın");
        }
    }
}
