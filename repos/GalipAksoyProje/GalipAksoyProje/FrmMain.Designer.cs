namespace GalipAksoyProje
{
	partial class FrmMain
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Excell Oluştur";
			this.button1.UseVisualStyleBackColor = true;
			this.button1.Click += new System.EventHandler(this.button1_Click);
			// 
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(292, 165);
			...
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(480, 165);
			this.button3.Name = "button3";
			this.button3.Size = new System.Drawing.Size(150, 59);
			this.button3.TabIndex = 2;
			this.button3.Text = "Word Oluştur";
